...
ALTER TABLE ssh_keys
  ...
  ADD COLUMN IF NOT EXISTS algorithm VARCHAR(32) NULL,
  ADD COLUMN IF NOT EXISTS encrypted TINYINT(1) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS usage_count INT NOT NULL DEFAULT 0;

ALTER TABLE nodes
  ADD COLUMN IF NOT EXISTS source VARCHAR(32) NOT NULL DEFAULT 'manual_ssh',
  ADD COLUMN IF NOT EXISTS provider VARCHAR(32) NULL,
  ADD COLUMN IF NOT EXISTS provider_instance_id VARCHAR(128) NULL,
  ADD COLUMN IF NOT EXISTS parent_host_id BIGINT UNSIGNED NULL;
