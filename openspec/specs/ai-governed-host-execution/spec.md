# Capability: ai-governed-host-execution

## Purpose
Define guarded AI-driven host command and script execution with preview, approval, policy enforcement, and auditable per-host results.
