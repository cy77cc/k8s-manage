...
type DeploymentRelease struct {
	...
	RuntimeType       string    `gorm:"column:runtime_type;type:varchar(16);not null" json:"runtime_type"` // k8s|compose
	...
	Status            string    `gorm:"column:status;type:varchar(32);default:'created'" json:"status"`
