...
func clusterListInventory(ctx context.Context, deps PlatformDeps, input ClusterInventoryInput) (ToolResult, error) {
	return runWithPolicyAndEvent(ctx, ToolMeta{Name: "cluster_list_inventory", Mode: ToolModeReadonly, Risk: ToolRiskLow, Provider: "local", Permission: "ai:tool:read"}, input, func(in ClusterInventoryInput) (any, string, error) {
		if deps.DB == nil {
...
func serviceListInventory(ctx context.Context, deps PlatformDeps, input ServiceInventoryInput) (ToolResult, error) {
	return runWithPolicyAndEvent(ctx, ToolMeta{Name: "service_list_inventory", Mode: ToolModeReadonly, Risk: ToolRiskLow, Provider: "local", Permission: "ai:tool:read"}, input, func(in ServiceInventoryInput) (any, string, error) {
		if deps.DB == nil {
			return nil, "db", fmt.Errorf("db unavailable")
		}
		limit := in.Limit
