...
// testConnection tests connection using various auth methods
...
// buildRestConfigFromRequest builds REST config from request
...
// syncClusterNodesWithCred syncs cluster nodes using stored credential
